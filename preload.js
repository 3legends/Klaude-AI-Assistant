...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  resizeLlmWindow: (width, height) => ipcRenderer.invoke('resize-llm-window', { width, height }),
  resizeChatWindow: (width, height) => ipcRenderer.invoke('resize-chat-window', { width, height }),
